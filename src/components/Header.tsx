    ...
    <header className="bg-white border-b border-gray-200 sticky top-0 z-40 px-4 sm:px-8 py-3 flex items-center justify-between shrink-0">
      <div className="max-w-[1100px] mx-auto w-full flex items-center justify-between">
        ...
        <button
          ...
          className="flex items-center gap-2.5 text-left focus:outline-none focus-visible:ring-2 focus-visible:ring-teal-500 rounded-md py-1 cursor-pointer"
          aria-label="AVIFtoJPG.in Home"
        >
          <div className="w-8 h-8 bg-teal-600 rounded flex items-center justify-center text-white font-bold text-xs shadow-xs">
            A→J
          </div>
          <div className="flex flex-col">
            <span className="text-xl font-bold tracking-tight text-gray-800 leading-tight">
        ...
        <div className="flex items-center gap-3 text-sm">
          ...
          <div className="relative">
            <button
              ...
              className="text-xs sm:text-sm font-medium text-gray-700 hover:text-teal-600 flex items-center gap-1.5 px-2.5 sm:px-3 py-1.5 rounded-md hover:bg-gray-50 border border-gray-200 transition-colors cursor-pointer bg-white"
            ...
            {isLangOpen && (
              <>
                ...
                <div className="absolute right-0 mt-1 w-56 max-h-[380px] overflow-y-auto bg-white rounded-lg shadow-xl border border-gray-200 py-1.5 z-30 text-xs divide-y divide-gray-100">
